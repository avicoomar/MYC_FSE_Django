...
DATABASES = {
    'default': { 
    	...
    	'NAME': ':memory:', #use this if fixtures are loaded automatically by Django in "python manage.py test" for faster performance
    	#'NAME': BASE_DIR / 'db_test.sqlite3', #use this if you are loading fixture manually 
    	'TEST' : {
    	    'NAME': ':memory:', #use this if fixtures are loaded automatically by Django in "python manage.py test" for faster performance
    	    #'NAME': BASE_DIR / 'db_test.sqlite3', #use this if you are loading fixture manually
    	}
